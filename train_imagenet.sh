...
export DATA_PATH='/home/ruihan/data/imagenet/train'
export MAR_SIZE='mar_base'
# export OUTPUT_DIR="output_dir/${MAR_SIZE}"
export OUTPUT_DIR="output_dir/${MAR_SIZE}"
export CACHED_PATH='/home/ruihan/data/imagenet/mar-vae-cached-latents/train'
...
--epochs 1000 --warmup_epochs 100 --batch_size 64 --blr 1.0e-4 --diffusion_batch_mul 4 \
--output_dir ${OUTPUT_DIR} --wandb \
--data_path ${DATA_PATH} \
--online_eval --eval_bsz 256 \
--cfg 2.9 --cfg_schedule linear  --temperature 1.0 \
--num_iter 256 --num_sampling_steps 100 \
